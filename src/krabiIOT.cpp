...
uint8_t LCD::status(){return 0;}
uint8_t LCD::keypad (){return 0;}
uint8_t LCD::init_bargraph(uint8_t graphtype){return 0;}
void LCD::draw_horizontal_graph(uint8_t row, uint8_t column, uint8_t len,  uint8_t pixel_col_end){}
void LCD::draw_vertical_graph(uint8_t row, uint8_t column, uint8_t len,  uint8_t pixel_row_end){}
